 ...
 */
router.get('/', authenticate, requirePermission('mcp', 'read'), async (req, res) => {
  try {
 ...
 */
router.get('/:connectionId', authenticate, requirePermission('mcp', 'read'), async (req, res) => {
  try {
 ...
 */
router.post('/connect', authenticate, requirePermission('mcp', 'connect'), async (req, res) => {
  try {
    const userId = req.user?.id || 'unknown';
 ...
 */
router.post('/:connectionId/disconnect', authenticate, requirePermission('mcp', 'disconnect'), async (req, res) => {
  try {
    const { connectionId } = req.params;
    const userId = req.user?.id || 'unknown';
 ...
 */
router.post('/:connectionId/reconnect', authenticate, requirePermission('mcp', 'connect'), async (req, res) => {
  try {
    const { connectionId } = req.params;
    const userId = req.user?.id || 'unknown';
 ...
 */
router.get('/:connectionId/health', authenticate, requirePermission('mcp', 'read'), async (req, res) => {
  try {
    const { connectionId } = req.params;
 ...
 */
router.post('/:connectionId/request', authenticate, requirePermission('mcp', 'execute'), async (req, res) => {
  try {
    const { connectionId } = req.params;
 ...
 */
router.get('/:connectionId/tools', authenticate, requirePermission('mcp', 'read'), async (req, res) => {
  try {
    const { connectionId } = req.params;
    const connection = mcpConnectionManager.getConnection(connectionId);
 ...
 */
router.get('/:connectionId/resources', authenticate, requirePermission('mcp', 'read'), async (req, res) => {
  try {
    const { connectionId } = req.params;
    const connection = mcpConnectionManager.getConnection(connectionId);
 ...
 */
router.patch('/:connectionId/options', authenticate, requirePermission('mcp', 'manage'), async (req, res) => {
  try {
    const { connectionId } = req.params;
    const userId = req.user?.id || 'unknown';
 ...
 */
router.get('/:connectionId/stats', authenticate, requirePermission('mcp', 'read'), async (req, res) => {
  try {
    const { connectionId } = req.params;
    const connection = mcpConnectionManager.getConnection(connectionId);
 ...
 */
router.post('/test', authenticate, requirePermission('mcp', 'connect'), async (req, res) => {
  try {
    const userId = req.user?.id || 'unknown';
    const config: MCPConnectionConfig = req.body;

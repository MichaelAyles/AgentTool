...
const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({
  ...
  const [selectedMetrics, setSelectedMetrics] = useState<Set<string>>(
    new Set(['sessions', 'commands', 'users'])
  );
          ...
          <div className='h-64 bg-gray-50 dark:bg-gray-800 rounded-lg flex items-center justify-center'>
            <div className='text-center text-gray-500 dark:text-gray-400'>
              ...
              <div className='text-sm'>
                {chartType === 'line' ? 'Line Chart' : 'Bar Chart'} would be
                rendered here
              </div>
              <div className='text-xs mt-1'>
                Showing {Array.from(selectedMetrics).join(', ')} over{' '}
                {timeRange}
              </div>
            </div>
          </div>
            ...
            {data.adapters.mostUsed.map((adapter, index) => (
              ...
              >
                ...
                <div className='flex items-center space-x-2'>
                  ...
                  <div
                    className={`flex items-center space-x-1 ${getTrendColor(adapter.trend)}`}
                  >
              ...
              >
                <div className='flex items-center space-x-3'>
                  ...
                  <div>
                    ...
                    <div className='text-sm text-gray-500 dark:text-gray-400'>
                      {user.sessions} sessions • {formatNumber(user.commands)}{' '}
                      commands
                    </div>
                  </div>
                </div>

...
const AdapterDetails: React.FC<AdapterDetailsProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    'overview' | 'configuration' | 'documentation' | 'changelog'
  >('overview');
            ...
            <div className='flex items-center space-x-3'>
              ...
              {adapter.status === 'installed' ? (
                <>
                  ...
                  <button
                    onClick={() =>
                      handleOperation(() => onUpdate(adapter.id), 'updating')
                    }
                ...
                <button
                  onClick={() =>
                    handleOperation(() => onInstall(adapter.id), 'installing')
                  }
                  disabled={isOperating}
                ...
                <div className='bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4'>
                  ...
                  <div className='grid grid-cols-2 gap-4 text-sm'>
                    ...
                    <div>
                      ...
                      <span className='ml-2'>
                        {formatDate(adapter.installed.installedAt)}
                      </span>
                    </div>
                    ...
                    {adapter.installed.configuredAt && (
                      <div>
                        ...
                        <span className='ml-2'>
                          {formatDate(adapter.installed.configuredAt)}
                        </span>
                      </div>
                    )}
                  </div>
              ...
              <div>
                ...
                <div className='bg-gray-50 dark:bg-gray-800 rounded-lg p-4'>
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
                    ...
                    {adapter.requirements.system &&
                      adapter.requirements.system.length > 0 && (
                  ...
                  {adapter.requirements.dependencies &&
                    Object.keys(adapter.requirements.dependencies).length >
                      0 && (
                      <div className='mt-4'>
          ...
          {activeTab === 'documentation' && (
            <div className='space-y-6'>
              <div className='text-center py-8 text-gray-500 dark:text-gray-400'>
                ...
                <p>
                  Documentation will be loaded from the adapter's repository or
                  homepage.
                </p>
                {adapter.homepage && (
                  <a

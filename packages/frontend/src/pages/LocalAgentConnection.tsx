        ...
        <div className='mb-8'>
          ...
          <div className='space-y-2'>
            ...
            <p className='text-lg text-gray-600 dark:text-gray-400'>
              Connect your local machine to enable terminal interaction through
              this web interface.
            </p>
          </div>
        </div>
                ...
                <div className='flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg'>
                  <div>
                    ...
                    <p className='text-sm text-green-700 dark:text-green-300'>
                      Your local machine is now accessible through this web
                      interface.
                    </p>
                  </div>
                  <button
            ...
            <div className='space-y-3 text-sm text-blue-700 dark:text-blue-300'>
              <div>
                ...
                <ul className='list-disc list-inside mt-1 space-y-1'>
                  ...
                  <li>
                    Ensure you have sufficient permissions to install software
                  </li>
                  <li>
                    Try running the command with sudo if permission denied
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className='list-disc list-inside mt-1 space-y-1'>
                  ...
                  <li>
                    Only you can access your local machine through this session
                  </li>

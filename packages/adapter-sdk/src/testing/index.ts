      ...
      },
      {
        ...
        run: async adapter => {
          ...
          return {
            ...
            message:
              typeof version === 'string' && semverRegex.test(version)
                ? `Version: ${version}`
    ...
    const test: AdapterTest = {
      ...
      run: async adapter => {
        try {
          ...
          const hasInteractiveMethod =
            typeof (adapter as any).startInteractiveSession === 'function';
          return {
